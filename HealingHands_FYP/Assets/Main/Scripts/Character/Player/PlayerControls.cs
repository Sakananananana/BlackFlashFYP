...
public class PlayerControls : AnimationController
{
    ...
    private int _atkAnimationCount = 1;
    ...
    {
        _inputReader.DashEvent -= DashHandler;
        _playerCollider.excludeLayers = LayerMask.GetMask("Enemy");
    ...
    private IEnumerator PauseMovement()
    {
        ...
        //if (AttackPerformed)
        //{ 
        //    if (_atkAnimationCount == 1)
        //        _atkAnimationCount = 0;
        //    else
        //        _atkAnimationCount++;

        //    _anim.SetInteger("Attack", _atkAnimationCount);
